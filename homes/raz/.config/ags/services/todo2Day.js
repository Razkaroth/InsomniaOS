...
class Todo2DayService extends Service {
  static {
    Service.register(
      this,
      { 'updated': [], },
  ...
  constructor() {
    super();
    this._todoPath = `${GLib.get_user_cache_dir()}/ags/user/todo2Day.json`;
    try {
...
const service = new Todo2DayService();

// make it global for easy use with cli
globalThis.todo2Day = service;
